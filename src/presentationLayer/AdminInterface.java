...
import businessLayer.AdminOperations;
	...
	public AdminInterface() {
		...
		btnCreateConfirm.setOnAction(new EventHandler<ActionEvent>() {
		    ...
		    public void handle(ActionEvent e) {
		    	operations.insertStudent(nameCreateTextField.getText(), cnpCreateTextField.getText(), groupCreateTextField.getText());
		    }
		});
		...
		btnViewStudents.setOnAction(new EventHandler<ActionEvent>() {
		    ...
		    public void handle(ActionEvent e) {
		    	...
		    	ArrayList<Student> students = operations.getStudents();
		...
		btnUpdateConfirm.setOnAction(new EventHandler<ActionEvent>() {
		    ...
		    @Override
		    public void handle(ActionEvent e) {
		    	operations.updateStudent(idUpdateTextField.getText(), nameUpdateTextField.getText(), cnpUpdateTextField.getText(), groupUpdateTextField.getText());
		    }
		});
		...
		btnDeleteConfirm.setOnAction(new EventHandler<ActionEvent>() {
		    ...
		    @Override
		    public void handle(ActionEvent e) {
		    	operations.deleteStudent(deleteTextField.getText());
		    }
		});
		...
		btnReportConfirm.setOnAction(new EventHandler<ActionEvent>() {
		    ...
		    public void handle(ActionEvent e) {
		    	...
		    	for (String action : operations.generateLog(reportTextField.getText())) {
