...
import businessLayer.StudentOperations;
	...
	public StudentInterface(Integer id) {
    	...
    	btnViewStudent.setOnAction(new EventHandler<ActionEvent>() {
		    ...
		    public void handle(ActionEvent e) {
		    	Student self = operations.getStudent(id);
		    	if (self == null)
		...
		btnUpdateConfirm.setOnAction(new EventHandler<ActionEvent>() {
		    ...
		    @Override
		    public void handle(ActionEvent e) {
		    	operations.updateStudent(id.toString(), nameUpdateTextField.getText(), cnpUpdateTextField.getText(), groupUpdateTextField.getText());
		    }
		});
		...
		btnViewCourses.setOnAction(new EventHandler<ActionEvent>() {
		    ...
		    public void handle(ActionEvent e) {
                ...
                ArrayList<Course> courses = operations.getCourses();
		...
		btnViewGrades.setOnAction(new EventHandler<ActionEvent>() {
		    ...
		    public void handle(ActionEvent e) {
                ...
                ArrayList<Enrolment> enrolments = operations.getEnrolments(id);
		...
		btnEnrollConfirm.setOnAction(new EventHandler<ActionEvent>() {
		    ...
		    @Override
		    public void handle(ActionEvent e) {
		    	operations.enrolStudent(id, enrollTextField.getText());
		    }
		});
